...
import io.github.elkhoudiry.klogger.server.data.database.cassandra.events.EventsCassandraCache
...
class CassandraDatabase(
    ...
    val events by lazy { EventsCassandraCache(cassandra.session, keyspace) }
