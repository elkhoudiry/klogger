...
include(":server-data-database-common")
project(":server-data-database-common").projectDir = file("server/data/database/common")
include(":server-data-database-cassandra")
project(":server-data-database-cassandra").projectDir = file("server/data/database/cassandra")
